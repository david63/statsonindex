...
namespace david63\statsonindex;
	...
	public function is_enableable()
 	{
		...
		if (!$is_enableable)
		{
			...
			{
				$this->container->get('language')->add_lang('ext_enable_error', 'david63/statsonindex');
			}
			else
			{
				$this->container->get('user')->add_lang_ext('david63/statsonindex', 'ext_enable_error');
			}
		}
